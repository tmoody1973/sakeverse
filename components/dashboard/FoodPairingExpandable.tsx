        ...
        {active && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-4 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-[550px] md:max-h-[80vh] z-50"
            >
              <div
                ref={ref}
                className="bg-white border-3 border-ink shadow-retro-lg rounded-2xl overflow-hidden h-full flex flex-col"
              >
                {/* Header */}
